...
public class Constants {
    ...
    public static final String INTENT_ROOM_INFO = "ROOM_INFO";
    ...
    public static final String KEY_REQUEST_ROOM_ID = "reqRoomID";
    public static final String KEY_ACCEPT = "accept";
    public static final String KEY_ERROR = "error";
    public static final String KEY_PONG_TIMEOUT = "pongTimeout";

    public static final String KEY_POSITION = "position";
    public static final String KEY_REQUEST_USER_ID = "reqUserID";
    ...
    public static final String KEY_IS_AUDIO_ANCHOR = "isAudioAnchor";
